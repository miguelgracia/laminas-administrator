...
class DatatableConfigService extends DatatableConfig implements DatatableConfigInterface
{
    public function getDatatableConfig()
    {
        ...
        $canEdit    = $this->permissions->hasModuleAccess('static-page', 'edit');
        $canDelete  = $this->permissions->hasModuleAccess('static-page', 'delete');
        ...
        return array(
            ...
            'parse_row_data'=> function ($row) use($controllerPlugin, $canDelete, $canEdit) {
                ...
                $editUrl = $controller->goToSection('static-page',array('action' => 'edit', 'id' => $row['id']),true);
                $deleteUrl = $controller->goToSection('static-page',array('action' => 'delete','id' => $row['id']),true);
