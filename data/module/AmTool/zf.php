 ...
 *
 * @link      http://github.com/zendframework/AmTool for the canonical source repository
 * @copyright Copyright (c) 2005-2014 Zend Technologies USA Inc. (http://www.zend.com)
 * @license   http://framework.zend.com/license/new-bsd New BSD License
 */
$basePath = getcwd();

ini_set('user_agent', 'AmTool - Zend Framework 2 command line tool');
...
if (file_exists("$basePath/config/application.config.php")) {
    ...
    if (!isset($appConfig['modules']['AmTool'])) {
        $appConfig['modules'][] = 'AmTool';
