...
class GestorMenu extends Menu
{
     ...
     *
     * DREAMSITE: Sobreescribimos la función para poder añadir una clase al ul de una subsección del menú
     *
        ...
        foreach ($iterator as $page) {
            ...
            if ($depth > $prevDepth) {
                ...
                if ($ulClass && $depth ==  0) {
                    ...
                    /*
                     * buscamos la opción pagesWrapClass (creada por nosotros para añadir al ul del submenú)
