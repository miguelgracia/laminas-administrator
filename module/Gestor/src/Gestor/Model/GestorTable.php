...
abstract class GestorTable extends AbstractTableGateway implements AdapterAwareInterface
{
    ...
    {
        //extraemos el nombre de la clase del que hereda GestorTable y quitarmos los 5 últimos
    ...
    public function setDbAdapter(Adapter $adapter)
    {
        ...
        $resultSetPrototype = new GestorResultSet();
