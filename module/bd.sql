...
MySQL - 10.1.8-MariaDB : Database - bbva_colectivos_zend
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`bbva_colectivos_zend` /*!40100 DEFAULT CHARACTER SET latin1 */;

USE `bbva_colectivos_zend`;
...
insert  into `gestor_controlador`(`id`,`nombre_zend`,`nombre_usable`) values (1,'home','home'),(2,'configuration','Valores de configuraci√≥n'),(3,'gestor-usuarios','Usuarios del gestor'),(4,'perfil','Perfiles'),(5,'permisos','Permisos'),(6,'entrada-menu','Entradas de men√∫'),(10,'especialistas','Especialistas'),(19,'gestor-controlador','Controladores');
...
insert  into `gestor_menu`(`id`,`gestor_controlador_id`,`padre`,`texto`,`accion`,`tiene_enlace`,`orden`) values (2,2,-1,'Configuraci√≥n',NULL,1,90),(201,2,2,'Valores Generales','index',1,1),(202,3,2,'Usuarios','index',1,2),(203,4,2,'Perfil','index',1,3),(204,5,2,'Permisos','index',1,4),(205,6,2,'Men√∫','index',1,5),(206,19,2,'Controladores','index',1,6),(207,10,-1,'Especialistas','index',1,1);
...
insert  into `gestor_usuarios`(`id`,`gestor_perfil_id`,`login`,`password`,`fecha_alta`,`ultimo_login`,`validado`,`activo`) values (1,1,'dreamsite','∞LÎO„\0üM–\ZåK¢Ø','2016-01-13 12:42:11','2016-04-22 09:33:56',1,1),(2,2,'coordinador','\\e±óÂG≠ŒÍQ≈Œ®˜Ef!∏°q`Å	d…≤','2016-01-13 12:42:11','2016-04-05 11:00:53',1,1),(3,4,'entropy','«Ÿ7tôëÌK;]u(©;î','2016-03-29 12:05:16','2016-04-18 17:45:34',1,1),(4,4,'bbva','!ÔÛ`ªï¡CΩ?1é?}AŸ˙1\"JÜqÄlÓ‘uS','2016-03-30 18:13:54','2016-04-13 17:18:48',1,1),(3797,3,'U502562','&˘∂lVÁ¡È¨Ämã›eØè','2016-03-29 12:29:19','2016-04-19 14:34:46',1,1),(3799,2,'usercito','@ËäB<\0#¨øÑ˚&*cZ','2016-04-21 11:54:07','2016-04-21 16:55:16',0,1);
...
insert  into `valores_configuracion`(`id`,`entry_key`,`entry_value`) values (1,'nameAuthor','4422222222'),(2,'nameClient','Col ZF2'),(3,'introText','Content Manager for Business XXX '),(4,'logoImage','444.jpg'),(5,'upperImage','444.jpg'),(6,'jareImage','555.jpg');
